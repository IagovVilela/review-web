...
<head> 
    ...
    <style> 
        ...
        input { width: 100 10px; border: 1px solid #ddd; border-radius: 5px; box-sizing: border-box; } 
        .btn { width: 100 12px; background: #007bff; color: white; border: none; border-radius: 5px; cursor: pointer; } 
